...
public class AdMobInterstitialSplash {
...
//        if (PrefUtil.Companion.isPremium(your_activity_context))
//            return;
            ...
            InterstitialAd.load(mContext, your_interstitial_id, adRequest_interstitial,
                    new InterstitialAdLoadCallback() {
                        ...
                        public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                            ...
                            InterstitialLoadedListenerImplementerSplash.onInterstitialLoadedCalled();
                        }
                        ...
                        public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                            ...
                            InterstitialLoadedListenerImplementerSplash.onInterstitialFailedCalled();
                        }
                    });
        } else {
...
//                    if(!isBackPressed)
                    ...
                    loadInterstitialAd(mContext, yourActivity.getString(R.string.sp_intrestitial_ad));
                    InterstitialLoadListenerImplementerSplash.onInterstitialClosedCalled();
                ...
                public void onAdFailedToShowFullScreenContent(@NonNull AdError adError) {
                    ...
                    isInterstitialShown = false;
                    InterstitialLoadListenerImplementerSplash.onInterstitialFailedToShowCalled();
                    Log.d(logTag, "Interstitial Closed.");
            ...
            isAlreadyLoaded = false;
            loadInterstitialAd(mContext, mContext.getString(R.string.sp_intrestitial_ad));
        }
    }
